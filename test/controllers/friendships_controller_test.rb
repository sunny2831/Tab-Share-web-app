...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { user1_id: @friendship.user1_id, user2_id: @friendship.user2_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { user1_id: @friendship.user1_id, user2_id: @friendship.user2_id } }
